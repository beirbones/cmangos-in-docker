...
ENV DBBACKUPS="ON"
ENV DBBACKUPS_TOTALCOUNT=5
ENV FULLBACKUPS_TOTALCOUNT=2
...
CMD ["sh", "-c", "entrypoint.sh $EXPANSION $MARIADB_ROOT_PASSWORD $MARIADB_MANGOS_USER_PASSWORD $MARIADB_CONTAINER_NAME $AHBOT $PLAYERBOTS $REALM_NAME $IP_ADDRESS $CORE_COMMIT_ID $DB_COMMIT_ID $DBBACKUPS $DBBACKUPS_TOTALCOUNT $FULLBACKUPS_TOTALCOUNT"]
